  ...
  return (
    <div className="min-h-screen bg-background dark relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-primary/5 to-orange-500/5 rounded-full blur-3xl" />
      </div>
