...
import { ArrowLeft, Download, Upload, Wallet, RefreshCw, ExternalLink, TrendingUp } from "lucide-react";
...
const Vault = () => {
  ...
  const totalVaultValue = tokens.reduce((sum, t) => sum + parseFloat(t.usdValue.replace('$', '')), 0);
            ...
            <div className="rounded-xl border border-border bg-card p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="font-mono text-3xl font-bold text-foreground">${totalVaultValue.toFixed(2)}</p>
                </div>
